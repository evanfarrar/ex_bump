...
canvas = Canvas.size(%Size{height: 400, width: 400}) |> Canvas.fill(canvas, color: Color.named(:red))
Bump.write(filename: "red.bmp", canvas: canvas)
canvas2 = Canvas.fill(canvas, color: Color.named(:blue), rect: %Rect{ size: %Size{height: 200, width: 200}, origin: %Point{x: 100, y: 100}})
